...
myXmonadBar = "dzen2 -x '0' -y '0' -h '25' -w '475' -ta 'l' -fn '-*-inconsolata-*-r-normal-*-*-140-*-*-*-*-iso8859-*' -fg '#ffffff' -bg '#1B1D1E' -e 'button'"
myStatusBar = "conky -c /home/x4w3/.xmonad/.conky_dzen | dzen2 -x '475' -y '0' -w '750' -h '25' -ta 'r' -fn '-*-inconsolata-*-r-normal-*-*-140-*-*-*-*-iso8859-*' -bg '#1B1D1E' -fg '#ffffff' -e 'button'"
myStatusBar2 = "conky -c /home/x4w3/.xmonad/.conky_dzen2 | dzen2 -x '0' -y '1200' -w '1200' -h '25' -ta 'r' -fn '-*-inconsolata-*-r-normal-*-*-140-*-*-*-*-iso8859-*' -bg '#1B1D1E' -fg '#ffffff' -e 'button'"
myBitmapDir = "/home/x4w3/.xmonad/dzen2"

main = do
    dzenLeftBar <- spawnPipe myXmonadBar
    dzenRightBar <- spawnPipe myStatusBar
    dzenDownBar <- spawnPipe myStatusBar2
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask .|. controlMask,    xK_n        ), appendFilePrompt def "/home/x4w3/notas")
